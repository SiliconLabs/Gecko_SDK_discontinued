                           ...
                           unsigned char output[16] )
{
    ...
    {
        /* Load plaintext */
        CRYPTO_DataWrite( &CRYPTO->DATA0, (uint32_t*)input );
    ...
    /* Save encrypted/decrypted data */
    CRYPTO_DataRead( &CRYPTO->DATA0, (uint32_t*)output);
                           ...
                           unsigned char *output )
{
    ...
    if( mode == MBEDTLS_AES_ENCRYPT )
    {
        ...
        crypto_aes_processloop( length,
                                &CRYPTO->DATA1, (uint32_t*) input,
                                &CRYPTO->DATA0, (uint32_t*) output,
                                0 );
                       ...
                       unsigned char *output )
{
    ...
    else
    {
        ...
        CRYPTO_DataWrite( &CRYPTO->DATA1, (uint32_t*)nonce_counter );
        ...
        crypto_aes_processloop( length,
                                &CRYPTO->DATA2, (uint32_t*)input,
                                &CRYPTO->DATA0, (uint32_t*)output,
                                0);
      
        CRYPTO_DataRead( &CRYPTO->DATA1, (uint32_t*)nonce_counter );
