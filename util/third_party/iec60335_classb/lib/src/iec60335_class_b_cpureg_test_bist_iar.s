;/***************************************************************************//**
; * @file     iec60335_class_b_cpureg_test_bist_iar.s
; * @brief    assemble based BIST CPU register test for IAR compiler
...
; ******************************************************************************/
    ...
    THUMB
;/* functions exported */
    PUBLIC         ASMCPUregTestLOW
    PUBLIC         ASMCPUregTestHIGH
    PUBLIC         ASMCPUregTestSP
    PUBLIC         ASMCPUregTestSPEC

;/* external struct */
    EXTERN         IEC60335_CPUregTestBIST
