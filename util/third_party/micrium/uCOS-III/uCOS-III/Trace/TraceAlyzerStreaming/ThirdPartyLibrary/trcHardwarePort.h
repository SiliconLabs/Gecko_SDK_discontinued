...
#define TRC_PORT_ARM_Cortex_M_DWT				2
#define TRC_PORT_ARM_CORTEX_A9					3
#define TRC_PORT_Renesas_RX600					4
#define TRC_PORT_TEXAS_INSTRUMENTS_TMS570_RM48	5
#define TRC_PORT_MICROCHIP_PIC32_MX_MZ			6
...
#define TRC_FREE_RUNNING_32BIT_INCR 1	/* Not currently supported */
#define TRC_FREE_RUNNING_32BIT_DECR 2	/* Not currently supported */
...
#define TRC_OS_TIMER_DECR 4
	...
	#define HWTC_COUNT (*((volatile uint32_t*)0xE000E018)) /* SysTick counter */
	#define IRQ_PRIORITY_ORDER 0

	#define TRC_PORT_SPECIFIC_INIT() 

#elif (TRC_RECORDER_HARDWARE_PORT == TRC_PORT_ARM_Cortex_M_DWT)
	...
	#define HWTC_TYPE TRC_FREE_RUNNING_32BIT_INCR
	#define HWTC_COUNT (REG_DWT_CYCCNT)
	...
	// Decreasing counters are better for LowPowerModes where the reload register is tampered with.
	#define HWTC_TYPE TRC_OS_TIMER_DECR
	#define HWTC_COUNT (CMT0.CMCOR - CMT0.CMCNT)
	...
	#define RTIFRC0 *((volatile uint32_t *)0xFFFFFC10)
	#define RTICOMP0 *((volatile uint32_t *)0xFFFFFC50)
	#define RTIUDCP0 *((volatile uint32_t *)0xFFFFFC54)

	// Decreasing counters are better for LowPowerModes where the reload register is tampered with.
	#define HWTC_TYPE TRC_OS_TIMER_DECR
	#define HWTC_COUNT (RTICOMP0 - RTIFRC0)
	//#define HWTC_TYPE TRC_OS_TIMER_INCR
	//#define HWTC_COUNT (RTIFRC0 - (RTICOMP0 - RTIUDCP0))
	//#define HWTC_TYPE TRC_FREE_RUNNING_32BIT_INCR
	//#define HWTC_COUNT (RTIFRC0)
	#define IRQ_PRIORITY_ORDER 0
