...
#define TRC_STREAM_PORT_ALLOCATE_EVENT(_type, _ptrData, _size) TRC_STREAM_CUSTOM_ALLOCATE_EVENT(_type, _ptrData, _size)
#define TRC_STREAM_PORT_COMMIT_EVENT(_ptrData, _size) TRC_STREAM_CUSTOM_COMMIT_EVENT(_ptrData, _size)
