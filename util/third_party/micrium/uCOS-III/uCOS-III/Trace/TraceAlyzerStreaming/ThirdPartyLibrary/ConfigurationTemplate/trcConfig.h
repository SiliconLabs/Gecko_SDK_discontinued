 ...
 ******************************************************************************/
#define TRC_RECORDER_HARDWARE_PORT TRC_PORT_NOT_SET
...
#define TRC_SYMBOL_TABLE_SLOTS NTask + NTaskSem + NTaskQ + NISR + NQueue + NSemaphore + NMutex + NFlag + NMem + 128
 ...
 ******************************************************************************/
#define TRC_CTRL_TASK_STACK_SIZE 512
 ...
 * We are aiming to remove this extra task in future versions.
 ******************************************************************************/
#define TRC_CTRL_TASK_PRIORITY 10
 ...
 * trace transfer.
 ******************************************************************************/
#define TRC_CTRL_TASK_DELAY ((10 * OS_CFG_TICK_RATE_HZ) / 1000)
