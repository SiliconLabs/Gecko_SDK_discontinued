...
*********************************************************************************************************
*/
                                                                /* $$$$ Configure CPU data types (see Note #1) :        */
...
typedef  unsigned  long        CPU_INT64U;                      /* 64-bit unsigned integer ($$$$ if available)          */
typedef    signed  long        CPU_INT64S;                      /* 64-bit   signed integer ($$$$ if available)          */

typedef            float       CPU_FP32;                        /* 32-bit floating point   ($$$$ if available)          */
typedef            double      CPU_FP64;                        /* 64-bit floating point   ($$$$ if available)          */
...
typedef  volatile  CPU_INT64U  CPU_REG64;                       /* 64-bit register         ($$$$ if available)          */
...
*/
                                                                ...
                                                                /* $$$$ Configure CPU critical section :                */
...
#define  CPU_INT_DIS()         do { CPU_SR_Push(); } while (0)          /* Push    CPU status word & disable interrupts.*/
#define  CPU_INT_EN()          do { CPU_SR_Pop();  } while (0)          /* Pop     CPU status word.                     */
#endif
...
*********************************************************************************************************
*/
                                                                /* $$$$ Prototype CPU port functions (if required) :    */
void    CPU_IntDis    (void);                                   /* Disable interrupts.                                  */
void    CPU_IntEn     (void);                                   /* Enable  interrupts.                                  */

void    CPU_SR_Push   (void);                                   /* Push    CPU status word & disable interrupts.        */
void    CPU_SR_Pop    (void);                                   /* Pop     CPU status word.                             */
