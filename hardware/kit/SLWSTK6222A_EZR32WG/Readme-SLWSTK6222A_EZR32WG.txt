...
This package include examples for the SLWSTK6222A_EZR32WG radio development
kit from Silicon Labs.
The SLWSTK6222A_EZR32WG device is a 915MHz radio with +20dBm output.

====== Dependencies ======

This package _requires_ the EM_BSP_COMMON and the CMSIS packages to be
...
CMSIS package. See the Changes file for required version.

The CMSIS package requires C99 support, and so does this package.

====== File structure ======

kits/SLWSTK6222A_EZR32WG/config
   Configuration data for BSP and Drivers in EM_BSP_COMMON.

kits/SLWSTK6222A_EZR32WG/examples
