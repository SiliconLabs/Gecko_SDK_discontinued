...
void CoreMark_Main(int argc, char *argv[]) {
	...
	if ((results[0].seed1==0) && (results[0].seed2==0) && (results[0].seed3==0x66)) { /* perfromance run */
		results[0].seed1=0;
		results[0].seed2=0;
		results[0].seed3=0x66;
	}
	if ((results[0].seed1==0x3415) && (results[0].seed2==0x3415) && (results[0].seed3==0x66)) { /* validation run */
