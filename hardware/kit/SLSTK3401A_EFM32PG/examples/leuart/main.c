...
#define LEUART_TX_LOCATION 0
#define LEUART_RX_LOCATION 0
#define LEUART_TXPORT      gpioPortA                      /* LEUART transmission port */
#define LEUART_TXPIN       0                              /* LEUART transmission pin */
#define LEUART_RXPORT      gpioPortA                      /* LEUART reception port */
#define LEUART_RXPIN       1                              /* LEUART reception pin */
...
void setupLeuart(void)
{
  ...
  LEUART0->ROUTELOC0 = (LEUART0->ROUTELOC0 & ~(_LEUART_ROUTELOC0_TXLOC_MASK
                      ...
                      | (LEUART_TX_LOCATION << _LEUART_ROUTELOC0_TXLOC_SHIFT)
                      | (LEUART_RX_LOCATION << _LEUART_ROUTELOC0_RXLOC_SHIFT);
