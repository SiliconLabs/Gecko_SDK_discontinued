...
int ecp_device_add_mixed( const mbedtls_ecp_group *grp,
                          mbedtls_ecp_point *R,
                          const mbedtls_ecp_point *P,
                          const mbedtls_ecp_point *Q );
#endif
#if defined(MBEDTLS_ECP_NORMALIZE_JAC_ALT)
int ecp_device_normalize_jac( const mbedtls_ecp_group *grp,
                              mbedtls_ecp_point *R );
#endif
 ...
 */
unsigned long add_count, dbl_count, mul_count, normalize_jac_count, normalize_jac_many_count;
#endif
...
static int ecp_normalize_jac( const mbedtls_ecp_group *grp, mbedtls_ecp_point *pt )
{
    ...
    {
        return ecp_device_normalize_jac( grp, pt );
    }
...
#if defined(MBEDTLS_SELF_TEST)
    normalize_jac_many_count++;
#endif
    
#if defined(MBEDTLS_ECP_NORMALIZE_JAC_MANY_ALT)
    if (mbedtls_ecp_device_grp_capable( grp ))
    {
        return ecp_device_normalize_jac_many(grp, T, t_len);
    }
#endif
                           ...
                           const mbedtls_ecp_point *P )
{
    ...
    if (mbedtls_ecp_device_grp_capable( grp ))
    {
        return ecp_device_double_jac( grp, R, P );
    }
                          ...
                          const mbedtls_ecp_point *P, const mbedtls_ecp_point *Q )
{
    ...
    if (mbedtls_ecp_device_grp_capable( grp ))
    {
        return ecp_device_add_mixed( grp, R, P, Q );
    }
                                ...
                                unsigned char w, size_t d )
{
    ...
    if (mbedtls_ecp_device_grp_capable( grp ) )
    {
        MBEDTLS_MPI_CHK( mbedtls_ecp_device_init( grp ) );
    }
#endif
