...
__cs3_interrupt_vector_em:
    ...
    .long   OS_CPU_PendSV_Handler       /* PendSVPendSV Handler         */
    .long   OS_CPU_SysTick_Handler      /* PendSVSysTick Handler        */
...
_IRQHandlerinterrupt:
    ...
    .globl  OS_CPU_PendSV_Handler
    .set    OS_CPU_PendSV_Handler, _IRQHandlerinterrupt
    .weak   OS_CPU_SysTick_Handler
    .globl  OS_CPU_SysTick_Handler
    .set    OS_CPU_SysTick_Handler, _IRQHandlerinterrupt
    .weak   DMA_IRQHandler
    ...
    .globl  FPUEH_IRQHandler
    .set    FPUEH_IRQHandler, _IRQHandlerinterrupt
