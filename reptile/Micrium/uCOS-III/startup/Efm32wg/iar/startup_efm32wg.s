...
; *           Energy Micro 'EFM32WG' Device Series
; * @version 3.0.0
...
__vector_table_0x1c
        ...
        DCD     0
        DCD     OS_CPU_PendSVHandler            ; uC/OS-III, was PendSV_Handler
        DCD     OS_CPU_SysTickHandler           ; uC/OS-III, was SysTick_Handler
        ...
        DCD FPUEH_IRQHandler  ; 39: EMU Interrupt
...
FPCCR_ADDRESS     DEFINE    0xE000EF34       ; FPU Context Control register
LSPEN_ASPEN_MASK  DEFINE    0x3FFFFFFF       ; FPCCR LSPEN and ASPEN mask
...
;; Disable automatic FPU register context save and lazy FPU context save
        LDR     R0, =FPCCR_ADDRESS
        LDR     R1, =LSPEN_ASPEN_MASK
        LDR     R2, [R0]
        AND     R2, R2, R1
        STR     R2, [R0]
...
SysTick_Handler
        B SysTick_Handler
        ; EFM32GG/LG specific interrupt handlers
