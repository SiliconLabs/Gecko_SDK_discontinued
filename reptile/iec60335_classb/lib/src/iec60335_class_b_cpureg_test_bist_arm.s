;/***************************************************************************//**
; * @file   iec60335_class_b_cpureg_test_bist_arm.s
; * @brief  IEC60335 Class B CPU register tests
; *             assemble based BIST CPU register test for ARM compiler
; * @version 1.0.0
; *******************************************************************************
; * @section License
...
; ******************************************************************************/
    ...
    THUMB
;/* functions exported */
    EXPORT          ASMCPUregTestLOW
    EXPORT          ASMCPUregTestHIGH
    EXPORT          ASMCPUregTestSP
    EXPORT          ASMCPUregTestSPEC
