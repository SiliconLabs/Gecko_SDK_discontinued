...
#define AF_CMU_CLK0_PIN(i)        ((i) == 0 ? -1 : (i) == 1 ? -1 : (i) == 2 ? 7 : (i) == 3 ? 2 :  -1)
...
#define AF_TIMER0_CC1_PIN(i)      ((i) == 0 ? 1 : (i) == 1 ? 1 : (i) == 2 ? -1 : (i) == 3 ? -1 : (i) == 4 ? -1 : (i) == 5 ? 1 : (i) == 6 ? 0 :  -1)
#define AF_TIMER0_CC2_PIN(i)      ((i) == 0 ? -1 : (i) == 1 ? -1 : (i) == 2 ? -1 : (i) == 3 ? -1 : (i) == 4 ? -1 : (i) == 5 ? 2 : (i) == 6 ? 2 :  -1)
#define AF_TIMER0_CDTI0_PIN(i)    ((i) == 0 ? -1 : (i) == 1 ? 13 : (i) == 2 ? -1 : (i) == 3 ? -1 : (i) == 4 ? -1 : (i) == 5 ? 3 : (i) == 6 ? 13 :  -1)
#define AF_TIMER0_CDTI1_PIN(i)    ((i) == 0 ? -1 : (i) == 1 ? 14 : (i) == 2 ? -1 : (i) == 3 ? -1 : (i) == 4 ? -1 : (i) == 5 ? 4 : (i) == 6 ? 14 :  -1)
#define AF_TIMER0_CDTI2_PIN(i)    ((i) == 0 ? -1 : (i) == 1 ? 15 : (i) == 2 ? -1 : (i) == 3 ? -1 : (i) == 4 ? -1 : (i) == 5 ? -1 : (i) == 6 ? 15 :  -1)
...
#define AF_TIMER2_CC0_PIN(i)      ((i) == 0 ? -1 : (i) == 1 ? -1 : (i) == 2 ? 8 : (i) == 3 ? 2 :  -1)
#define AF_TIMER2_CC1_PIN(i)      ((i) == 0 ? -1 : (i) == 1 ? -1 : (i) == 2 ? 9 : (i) == 3 ? 12 :  -1)
#define AF_TIMER2_CC2_PIN(i)      ((i) == 0 ? -1 : (i) == 1 ? -1 : (i) == 2 ? 10 : (i) == 3 ? 13 :  -1)
...
#define AF_USART0_TX_PIN(i)       ((i) == 0 ? 10 : (i) == 1 ? -1 : (i) == 2 ? 11 : (i) == 3 ? 13 : (i) == 4 ? 7 : (i) == 5 ? -1 : (i) == 6 ? -1 :  -1)
...
#define AF_USARTRF1_TX_PIN(i)     ((i) == 0 ? -1 : (i) == 1 ? -1 : (i) == 2 ? 7 : (i) == 3 ? -1 : (i) == 4 ? -1 : (i) == 5 ? 1 :  -1)
#define AF_USARTRF1_RX_PIN(i)     ((i) == 0 ? -1 : (i) == 1 ? -1 : (i) == 2 ? 6 : (i) == 3 ? -1 : (i) == 4 ? -1 : (i) == 5 ? 2 :  -1)
#define AF_USARTRF1_CLK_PIN(i)    ((i) == 0 ? -1 : (i) == 1 ? -1 : (i) == 2 ? -1 : (i) == 3 ? -1 : (i) == 4 ? -1 : (i) == 5 ? 3 :  -1)
#define AF_USARTRF1_CS_PIN(i)     ((i) == 0 ? -1 : (i) == 1 ? -1 : (i) == 2 ? -1 : (i) == 3 ? -1 : (i) == 4 ? -1 : (i) == 5 ? 0 :  -1)
#define AF_PRS_CH0_PIN(i)         ((i) == 0 ? 0 : (i) == 1 ? 3 : (i) == 2 ? 14 : (i) == 3 ? 2 :  -1)
#define AF_PRS_CH1_PIN(i)         ((i) == 0 ? 1 : (i) == 1 ? 4 : (i) == 2 ? 15 : (i) == 3 ? 12 :  -1)
#define AF_PRS_CH2_PIN(i)         ((i) == 0 ? -1 : (i) == 1 ? -1 : (i) == 2 ? 10 : (i) == 3 ? 13 :  -1)
...
#define AF_PCNT0_S0IN_PIN(i)      ((i) == 0 ? 13 : (i) == 1 ? -1 : (i) == 2 ? -1 : (i) == 3 ? 6 : (i) == 4 ? 0 :  -1)
#define AF_PCNT0_S1IN_PIN(i)      ((i) == 0 ? 14 : (i) == 1 ? -1 : (i) == 2 ? -1 : (i) == 3 ? 7 : (i) == 4 ? 11 :  -1)
#define AF_I2C0_SDA_PIN(i)        ((i) == 0 ? 0 : (i) == 1 ? 6 : (i) == 2 ? -1 : (i) == 3 ? -1 : (i) == 4 ? -1 : (i) == 5 ? 0 : (i) == 6 ? 12 :  -1)
