...
This package include examples for the SLSENSORPUCK_EFM32G development
kit from Silicon Labs.

====== Dependencies ======

This package _requires_ the EM_BSP_COMMON and CMSIS packages to be
...
kits/SLSENSORPUCK_EFM32G/config
   Configuration data for BSP and Drivers in EM_BSP_COMMON.

kits/SLSENSORPUCK_EFM32G/examples
   Example projects demonstrating various capabilities of the
   SLSENSORPUCK_EFM32G.
