...
// if_freq: -29296.875
// nb_filter: 2
// nb_filter_bw: 51.53125
// wb_filter: 2
// wb_filter_bw: 51.53125
...
#define RADIO_CONFIGURATION_DATA_RADIO_PACKET_LENGTH (7)
...
#define RF_SET_PROPERTY_GLOBAL_XO_TUNE 0x11, 0x00, 0x01, 0x00, 0x00
...
#define RF_SET_PROPERTY_INT_CTL_ENABLE 0x11, 0x01, 0x01, 0x00, 0x01
...
#define RF_SET_PROPERTY_PA_BIAS_CLKDUTY 0x11, 0x22, 0x01, 0x02, 0x00

#define RF_SET_PROPERTY_PA_RAMP_EX 0x11, 0x22, 0x01, 0x04, 0x00
...
#define RF_SET_PROPERTY_PKT_CRC_CONFIG 0x11, 0x12, 0x01, 0x00, 0x05
...
#define RF_SET_PROPERTY_PKT_WHT_BIT_NUM 0x11, 0x12, 0x01, 0x05, 0x00
...
#define RF_SET_PROPERTY_PKT_FIELD_1_LENGTH 0x11, 0x12, 0x02, 0x0D, 0x00, 0x07

#define RF_SET_PROPERTY_PKT_FIELD_1_CONFIG 0x11, 0x12, 0x01, 0x0F, 0x00

#define RF_SET_PROPERTY_PKT_FIELD_1_CRC_CONFIG 0x11, 0x12, 0x01, 0x10, 0xAA

#define RF_SET_PROPERTY_PKT_FIELD_2_LENGTH 0x11, 0x12, 0x02, 0x11, 0x00, 0x00
...
#define RF_SET_PROPERTY_MODEM_DATA_RATE 0x11, 0x20, 0x03, 0x03, 0x01, 0x77, 0x00

#define RF_SET_PROPERTY_MODEM_TX_NCO_MODE 0x11, 0x20, 0x04, 0x06, 0x01, 0xC9, 0xC3, 0x80

#define RF_SET_PROPERTY_MODEM_FREQ_DEV 0x11, 0x20, 0x03, 0x0A, 0x00, 0x01, 0x50

#define RF_SET_PROPERTY_MODEM_TX_RAMP_DELAY 0x11, 0x20, 0x01, 0x18, 0x01

#define RF_SET_PROPERTY_PA_TC 0x11, 0x22, 0x01, 0x03, 0x00

#define RF_SET_PROPERTY_FREQ_CONTROL_INTE 0x11, 0x40, 0x01, 0x00, 0x40

#define RF_SET_PROPERTY_FREQ_CONTROL_FRAC 0x11, 0x40, 0x03, 0x01, 0x0A, 0xAA, 0xAA

#define RF_SET_PROPERTY_FREQ_CONTROL_CHANNEL_STEP_SIZE 0x11, 0x40, 0x02, 0x04, 0x44, 0x44

#define RF_SET_PROPERTY_FREQ_CONTROL_W_SIZE 0x11, 0x40, 0x01, 0x06, 0x20

#define RF_SET_PROPERTY_FREQ_CONTROL_VCOCNT_RX_ADJ 0x11, 0x40, 0x01, 0x07, 0x00

#define RF_SET_PROPERTY_MODEM_MDM_CTRL 0x11, 0x20, 0x01, 0x19, 0x00

#define RF_SET_PROPERTY_MODEM_IF_CONTROL 0x11, 0x20, 0x01, 0x1A, 0x00

#define RF_SET_PROPERTY_MODEM_IF_FREQ 0x11, 0x20, 0x03, 0x1B, 0x03, 0xF8, 0x00

#define RF_SET_PROPERTY_MODEM_DECIMATION_CFG1 0x11, 0x20, 0x01, 0x1E, 0x30

#define RF_SET_PROPERTY_MODEM_DECIMATION_CFG0 0x11, 0x20, 0x01, 0x1F, 0x20

#define RF_SET_PROPERTY_MODEM_BCR_OSR 0x11, 0x20, 0x02, 0x22, 0x00, 0xC3

#define RF_SET_PROPERTY_MODEM_BCR_NCO_OFFSET 0x11, 0x20, 0x03, 0x24, 0x02, 0x9F, 0x17

#define RF_SET_PROPERTY_MODEM_BCR_GAIN 0x11, 0x20, 0x02, 0x27, 0x02, 0xA0
...
#define RF_SET_PROPERTY_MODEM_BCR_MISC1 0x11, 0x20, 0x01, 0x2A, 0x00

#define RF_SET_PROPERTY_MODEM_AFC_GEAR 0x11, 0x20, 0x01, 0x2C, 0x00

#define RF_SET_PROPERTY_MODEM_AFC_WAIT 0x11, 0x20, 0x01, 0x2D, 0x12

#define RF_SET_PROPERTY_MODEM_AFC_GAIN 0x11, 0x20, 0x02, 0x2E, 0x80, 0x54

#define RF_SET_PROPERTY_MODEM_AFC_LIMITER 0x11, 0x20, 0x02, 0x30, 0x04, 0xB1

#define RF_SET_PROPERTY_MODEM_AFC_MISC 0x11, 0x20, 0x01, 0x32, 0xA0
...
#define RF_SET_PROPERTY_MODEM_AGC_RFPD_DECAY 0x11, 0x20, 0x01, 0x39, 0x2B

#define RF_SET_PROPERTY_MODEM_AGC_IFPD_DECAY 0x11, 0x20, 0x01, 0x3A, 0x2B

#define RF_SET_PROPERTY_MODEM_FSK4_GAIN1 0x11, 0x20, 0x01, 0x3B, 0x80

#define RF_SET_PROPERTY_MODEM_FSK4_GAIN0 0x11, 0x20, 0x01, 0x3C, 0x1A

#define RF_SET_PROPERTY_MODEM_FSK4_TH 0x11, 0x20, 0x02, 0x3D, 0x40, 0x00

#define RF_SET_PROPERTY_MODEM_FSK4_MAP 0x11, 0x20, 0x01, 0x3F, 0x00

#define RF_SET_PROPERTY_MODEM_OOK_PDTC 0x11, 0x20, 0x01, 0x40, 0x29
...
#define RF_SET_PROPERTY_MODEM_OOK_MISC 0x11, 0x20, 0x01, 0x43, 0x23

#define RF_SET_PROPERTY_MODEM_RAW_SEARCH2 0x11, 0x20, 0x01, 0x50, 0x84

#define RF_SET_PROPERTY_MODEM_RAW_CONTROL 0x11, 0x20, 0x01, 0x45, 0x03

#define RF_SET_PROPERTY_MODEM_RAW_EYE 0x11, 0x20, 0x02, 0x46, 0x00, 0xA4
...
#define RF_SET_PROPERTY_MODEM_RSSI_CONTROL2 0x11, 0x20, 0x01, 0x4D, 0x1C

#define RF_SET_PROPERTY_MODEM_RSSI_COMP 0x11, 0x20, 0x01, 0x4E, 0x40

#define RF_SET_PROPERTY_MODEM_CHFLT_RX1_CHFLT_COE_0 0x11, 0x21, 0x0C, 0x00, 0xFF, 0xC4, 0x30, 0x7F, 0xF5, 0xB5, 0xB8, 0xDE, 0x05, 0x17, 0x16, 0x0C

#define RF_SET_PROPERTY_MODEM_CHFLT_RX1_CHFLT_COE_1 0x11, 0x21, 0x06, 0x0C, 0x03, 0x00, 0x15, 0xFF, 0x00, 0x00

#define RF_SET_PROPERTY_MODEM_CHFLT_RX2_CHFLT_COE_0 0x11, 0x21, 0x0C, 0x12, 0xFF, 0xC4, 0x30, 0x7F, 0xF5, 0xB5, 0xB8, 0xDE, 0x05, 0x17, 0x16, 0x0C

#define RF_SET_PROPERTY_MODEM_CHFLT_RX2_CHFLT_COE_1 0x11, 0x21, 0x06, 0x1E, 0x03, 0x00, 0x15, 0xFF, 0x00, 0x00
...
#define RF_SET_PROPERTY_MODEM_DSA_QUAL 0x11, 0x20, 0x01, 0x5D, 0x07
...
#define RF_SET_PROPERTY_GLOBAL_CLK_CFG 0x11, 0x00, 0x01, 0x01, 0x02

#define RF_SET_PROPERTY_GLOBAL_CONFIG 0x11, 0x00, 0x01, 0x03, 0x20

#define RF_SET_PROPERTY_GLOBAL_WUT_CONFIG 0x11, 0x00, 0x01, 0x04, 0x06

#define RF_SET_PROPERTY_GLOBAL_WUT_M 0x11, 0x00, 0x02, 0x05, 0x00, 0x00

#define RF_SET_PROPERTY_GLOBAL_WUT_R 0x11, 0x00, 0x01, 0x07, 0x60

#define RF_SET_PROPERTY_GLOBAL_WUT_LDC 0x11, 0x00, 0x01, 0x08, 0x00
...
#define RADIO_CONFIGURATION_DATA_BASE_FREQUENCY 490000000
#define RADIO_CONFIGURATION_DATA_BIT_ORDER FALSE
#define RADIO_CONFIGURATION_DATA_CENTER_FREQUENCY 490000000
...
#define RADIO_CONFIGURATION_DATA_DRIVE_STRENGTH com.ember.workbench.object_api.ObjectApiEnumItem@4036a11a
...
#define RADIO_CONFIGURATION_DATA_FLD_CRC_ENDIAN com.ember.workbench.object_api.ObjectApiEnumItem@428ad2e5
#define RADIO_CONFIGURATION_DATA_FLD_INVERT_CRC FALSE
#define RADIO_CONFIGURATION_DATA_FLD_MANCHESTER_PATTERN com.ember.workbench.object_api.ObjectApiEnumItem@281bda84
#define RADIO_CONFIGURATION_DATA_FLD_MODEM_4GFSK_MODE FALSE
#define RADIO_CONFIGURATION_DATA_FRR_CTL_A_MODE com.ember.workbench.object_api.ObjectApiEnumItem@3ca724ae
#define RADIO_CONFIGURATION_DATA_FRR_CTL_B_MODE com.ember.workbench.object_api.ObjectApiEnumItem@1593a9e
#define RADIO_CONFIGURATION_DATA_FRR_CTL_C_MODE com.ember.workbench.object_api.ObjectApiEnumItem@9175bc3
#define RADIO_CONFIGURATION_DATA_FRR_CTL_D_MODE com.ember.workbench.object_api.ObjectApiEnumItem@5c8963de
#define RADIO_CONFIGURATION_DATA_GPIO0 com.ember.workbench.object_api.ObjectApiEnumItem@3ffbb348
#define RADIO_CONFIGURATION_DATA_GPIO0_PULLUP FALSE
#define RADIO_CONFIGURATION_DATA_GPIO1 com.ember.workbench.object_api.ObjectApiEnumItem@25b75cc9
#define RADIO_CONFIGURATION_DATA_GPIO1_PULLUP FALSE
#define RADIO_CONFIGURATION_DATA_GPIO2 com.ember.workbench.object_api.ObjectApiEnumItem@292ca377
#define RADIO_CONFIGURATION_DATA_GPIO2_PULLUP FALSE
#define RADIO_CONFIGURATION_DATA_GPIO3 com.ember.workbench.object_api.ObjectApiEnumItem@319feebf
#define RADIO_CONFIGURATION_DATA_GPIO3_PULLUP FALSE
#define RADIO_CONFIGURATION_DATA_HOP_ENABLE com.ember.workbench.object_api.ObjectApiEnumItem@7af3570c
...
#define RADIO_CONFIGURATION_DATA_NIRQ com.ember.workbench.object_api.ObjectApiEnumItem@7dd813e3
...
#define RADIO_CONFIGURATION_DATA_PKT_CRC_POLY com.ember.workbench.object_api.ObjectApiEnumItem@7501dca0
#define RADIO_CONFIGURATION_DATA_PKT_CRC_SEED com.ember.workbench.object_api.ObjectApiEnumItem@4d3bc863
...
#define RADIO_CONFIGURATION_DATA_PKT_FIELD_LENGTH_0 7
...
#define RADIO_CONFIGURATION_DATA_POWER_PA_MODE com.ember.workbench.object_api.ObjectApiEnumItem@fe10332
...
#define RADIO_CONFIGURATION_DATA_RFPARAM_4GFSK_MAP com.ember.workbench.object_api.ObjectApiEnumItem@7d98cfc2
...
#define RADIO_CONFIGURATION_DATA_RFPARAM_DATA_RATE 9600
#define RADIO_CONFIGURATION_DATA_RFPARAM_DEVIATION 4800
...
#define RADIO_CONFIGURATION_DATA_RFPARAM_RSSI_AVERAGE com.ember.workbench.object_api.ObjectApiEnumItem@3b7009f9
#define RADIO_CONFIGURATION_DATA_RFPARAM_RSSI_JUMP_THRESHOLD 12
#define RADIO_CONFIGURATION_DATA_RFPARAM_RSSI_LATCH com.ember.workbench.object_api.ObjectApiEnumItem@389ed8eb
...
#define RADIO_CONFIGURATION_DATA_SDO com.ember.workbench.object_api.ObjectApiEnumItem@44b34957
#define RADIO_CONFIGURATION_DATA_SDO_PULLUP FALSE
#define RADIO_CONFIGURATION_DATA_SELECTED_CHIP si4463~revC2A
#define RADIO_CONFIGURATION_DATA_SW_CRC_CTRL FALSE
#define RADIO_CONFIGURATION_DATA_SW_WHT_CTRL FALSE
#define RADIO_CONFIGURATION_DATA_SYNC_ERROR_ONLY_BEGIN com.ember.workbench.object_api.ObjectApiEnumItem@569411fd
#define RADIO_CONFIGURATION_DATA_SYSCLOCK_32KHZ_CLOCK com.ember.workbench.object_api.ObjectApiEnumItem@13292573
#define RADIO_CONFIGURATION_DATA_SYSCLOCK_CLOCK_OUTPUT com.ember.workbench.object_api.ObjectApiEnumItem@7259aad8
