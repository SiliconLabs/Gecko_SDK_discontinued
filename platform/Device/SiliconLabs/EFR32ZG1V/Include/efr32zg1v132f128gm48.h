/**************************************************************************//**
 * @file efr32zg1v132f128gm48.h
 * @brief CMSIS Cortex-M Peripheral Access Layer Header File
 *        for EFR32ZG1V132F128GM48
 * @version 5.0.0
 ******************************************************************************
 * @section License
...
#ifndef EFR32ZG1V132F128GM48_H
#define EFR32ZG1V132F128GM48_H
...
/**************************************************************************//**
 * @defgroup EFR32ZG1V132F128GM48 EFR32ZG1V132F128GM48
 * @{
 *****************************************************************************/
...
/******  EFR32ZG1V Peripheral Interrupt Numbers ********************************************/
...
/**************************************************************************//**
 * @defgroup EFR32ZG1V132F128GM48_Core EFR32ZG1V132F128GM48 Core
 * @{
...
/** @} End of group EFR32ZG1V132F128GM48_Core */

/**************************************************************************//**
* @defgroup EFR32ZG1V132F128GM48_Part EFR32ZG1V132F128GM48 Part
* @{
******************************************************************************/
...
#if !defined(EFR32ZG1V132F128GM48)
#define EFR32ZG1V132F128GM48    1 /**< ZAPPY Gecko Part */
#endif

/** Configure part number */
#define PART_NUMBER               "EFR32ZG1V132F128GM48" /**< Part Number */
...
/** Flash and SRAM limits for EFR32ZG1V132F128GM48 */
...
#include "system_efr32zg1v.h" /* System Header File */

/** @} End of group EFR32ZG1V132F128GM48_Part */

/**************************************************************************//**
 * @defgroup EFR32ZG1V132F128GM48_Peripheral_TypeDefs EFR32ZG1V132F128GM48 Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/

#include "efr32zg1v_msc.h"
#include "efr32zg1v_emu.h"
#include "efr32zg1v_rmu.h"
#include "efr32zg1v_cmu.h"
#include "efr32zg1v_crypto.h"
#include "efr32zg1v_gpio_p.h"
#include "efr32zg1v_gpio.h"
#include "efr32zg1v_prs_ch.h"
#include "efr32zg1v_prs.h"
#include "efr32zg1v_ldma_ch.h"
#include "efr32zg1v_ldma.h"
#include "efr32zg1v_fpueh.h"
#include "efr32zg1v_gpcrc.h"
#include "efr32zg1v_timer_cc.h"
#include "efr32zg1v_timer.h"
#include "efr32zg1v_usart.h"
#include "efr32zg1v_leuart.h"
#include "efr32zg1v_letimer.h"
#include "efr32zg1v_cryotimer.h"
#include "efr32zg1v_pcnt.h"
#include "efr32zg1v_i2c.h"
#include "efr32zg1v_adc.h"
#include "efr32zg1v_acmp.h"
#include "efr32zg1v_idac.h"
#include "efr32zg1v_rtcc_cc.h"
#include "efr32zg1v_rtcc_ret.h"
#include "efr32zg1v_rtcc.h"
#include "efr32zg1v_wdog_pch.h"
#include "efr32zg1v_wdog.h"
#include "efr32zg1v_dma_descriptor.h"
#include "efr32zg1v_devinfo.h"
#include "efr32zg1v_romtable.h"

/** @} End of group EFR32ZG1V132F128GM48_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup EFR32ZG1V132F128GM48_Peripheral_Base EFR32ZG1V132F128GM48 Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32ZG1V132F128GM48_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EFR32ZG1V132F128GM48_Peripheral_Declaration  EFR32ZG1V132F128GM48 Peripheral Declarations
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32ZG1V132F128GM48_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup EFR32ZG1V132F128GM48_Peripheral_Offsets  EFR32ZG1V132F128GM48 Peripheral Offsets
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32ZG1V132F128GM48_Peripheral_Offsets */


/**************************************************************************//**
 * @defgroup EFR32ZG1V132F128GM48_BitFields EFR32ZG1V132F128GM48 Bit Fields
 * @{
 *****************************************************************************/

#include "efr32zg1v_prs_signals.h"
#include "efr32zg1v_dmareq.h"

/**************************************************************************//**
 * @defgroup EFR32ZG1V132F128GM48_UNLOCK EFR32ZG1V132F128GM48 Unlock Codes
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32ZG1V132F128GM48_UNLOCK */

/** @} End of group EFR32ZG1V132F128GM48_BitFields */

/**************************************************************************//**
 * @defgroup EFR32ZG1V132F128GM48_Alternate_Function EFR32ZG1V132F128GM48 Alternate Function
 * @{
 *****************************************************************************/

#include "efr32zg1v_af_ports.h"
#include "efr32zg1v_af_pins.h"

/** @} End of group EFR32ZG1V132F128GM48_Alternate_Function */
...
/** @} End of group EFR32ZG1V132F128GM48 */
