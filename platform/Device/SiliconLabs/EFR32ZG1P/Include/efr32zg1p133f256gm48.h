/**************************************************************************//**
 * @file efr32zg1p133f256gm48.h
 * @brief CMSIS Cortex-M Peripheral Access Layer Header File
 *        for EFR32ZG1P133F256GM48
 * @version 5.0.0
 ******************************************************************************
 * @section License
...
#ifndef EFR32ZG1P133F256GM48_H
#define EFR32ZG1P133F256GM48_H
...
/**************************************************************************//**
 * @defgroup EFR32ZG1P133F256GM48 EFR32ZG1P133F256GM48
 * @{
 *****************************************************************************/
...
/******  EFR32ZG1P Peripheral Interrupt Numbers ********************************************/
...
/**************************************************************************//**
 * @defgroup EFR32ZG1P133F256GM48_Core EFR32ZG1P133F256GM48 Core
 * @{
...
/** @} End of group EFR32ZG1P133F256GM48_Core */

/**************************************************************************//**
* @defgroup EFR32ZG1P133F256GM48_Part EFR32ZG1P133F256GM48 Part
* @{
******************************************************************************/

/** Part family */
#define _EFR32_ZAPPY_FAMILY                    1 /**< ZAPPY Gecko RF SoC Family  */
...
#if !defined(EFR32ZG1P133F256GM48)
#define EFR32ZG1P133F256GM48    1 /**< ZAPPY Gecko Part */
#endif

/** Configure part number */
#define PART_NUMBER               "EFR32ZG1P133F256GM48" /**< Part Number */
...
/** Flash and SRAM limits for EFR32ZG1P133F256GM48 */
...
#include "system_efr32zg1p.h" /* System Header File */

/** @} End of group EFR32ZG1P133F256GM48_Part */

/**************************************************************************//**
 * @defgroup EFR32ZG1P133F256GM48_Peripheral_TypeDefs EFR32ZG1P133F256GM48 Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/

#include "efr32zg1p_msc.h"
#include "efr32zg1p_emu.h"
#include "efr32zg1p_rmu.h"
#include "efr32zg1p_cmu.h"
#include "efr32zg1p_crypto.h"
#include "efr32zg1p_gpio_p.h"
#include "efr32zg1p_gpio.h"
#include "efr32zg1p_prs_ch.h"
#include "efr32zg1p_prs.h"
#include "efr32zg1p_ldma_ch.h"
#include "efr32zg1p_ldma.h"
#include "efr32zg1p_fpueh.h"
#include "efr32zg1p_gpcrc.h"
#include "efr32zg1p_timer_cc.h"
#include "efr32zg1p_timer.h"
#include "efr32zg1p_usart.h"
#include "efr32zg1p_leuart.h"
#include "efr32zg1p_letimer.h"
#include "efr32zg1p_cryotimer.h"
#include "efr32zg1p_pcnt.h"
#include "efr32zg1p_i2c.h"
#include "efr32zg1p_adc.h"
#include "efr32zg1p_acmp.h"
#include "efr32zg1p_idac.h"
#include "efr32zg1p_rtcc_cc.h"
#include "efr32zg1p_rtcc_ret.h"
#include "efr32zg1p_rtcc.h"
#include "efr32zg1p_wdog_pch.h"
#include "efr32zg1p_wdog.h"
#include "efr32zg1p_dma_descriptor.h"
#include "efr32zg1p_devinfo.h"
#include "efr32zg1p_romtable.h"

/** @} End of group EFR32ZG1P133F256GM48_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup EFR32ZG1P133F256GM48_Peripheral_Base EFR32ZG1P133F256GM48 Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32ZG1P133F256GM48_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EFR32ZG1P133F256GM48_Peripheral_Declaration  EFR32ZG1P133F256GM48 Peripheral Declarations
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32ZG1P133F256GM48_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup EFR32ZG1P133F256GM48_Peripheral_Offsets  EFR32ZG1P133F256GM48 Peripheral Offsets
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32ZG1P133F256GM48_Peripheral_Offsets */


/**************************************************************************//**
 * @defgroup EFR32ZG1P133F256GM48_BitFields EFR32ZG1P133F256GM48 Bit Fields
 * @{
 *****************************************************************************/

#include "efr32zg1p_prs_signals.h"
#include "efr32zg1p_dmareq.h"

/**************************************************************************//**
 * @defgroup EFR32ZG1P133F256GM48_UNLOCK EFR32ZG1P133F256GM48 Unlock Codes
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32ZG1P133F256GM48_UNLOCK */

/** @} End of group EFR32ZG1P133F256GM48_BitFields */

/**************************************************************************//**
 * @defgroup EFR32ZG1P133F256GM48_Alternate_Function EFR32ZG1P133F256GM48 Alternate Function
 * @{
 *****************************************************************************/

#include "efr32zg1p_af_ports.h"
#include "efr32zg1p_af_pins.h"

/** @} End of group EFR32ZG1P133F256GM48_Alternate_Function */
...
/** @} End of group EFR32ZG1P133F256GM48 */
