/**************************************************************************//**
 * @file efr32mg2p233f1024gl125.h
 * @brief CMSIS Cortex-M Peripheral Access Layer Header File
 *        for EFR32MG2P233F1024GL125
 * @version 5.0.0
 ******************************************************************************
 * @section License
...
#ifndef EFR32MG2P233F1024GL125_H
#define EFR32MG2P233F1024GL125_H
...
/**************************************************************************//**
 * @defgroup EFR32MG2P233F1024GL125 EFR32MG2P233F1024GL125
 * @{
 *****************************************************************************/
...
/******  EFR32MG12P Peripheral Interrupt Numbers ********************************************/
  ...
  FRC_PRI_IRQn          = 1,  /*!< 1 EFR32 FRC_PRI Interrupt */
  WDOG0_IRQn            = 2,  /*!< 2 EFR32 WDOG0 Interrupt */
  WDOG1_IRQn            = 3,  /*!< 3 EFR32 WDOG1 Interrupt */
  FRC_IRQn              = 4,  /*!< 4 EFR32 FRC Interrupt */
  MODEM_IRQn            = 5,  /*!< 5 EFR32 MODEM Interrupt */
  RAC_SEQ_IRQn          = 6,  /*!< 6 EFR32 RAC_SEQ Interrupt */
  RAC_RSM_IRQn          = 7,  /*!< 7 EFR32 RAC_RSM Interrupt */
  BUFC_IRQn             = 8,  /*!< 8 EFR32 BUFC Interrupt */
  ...
  AGC_IRQn              = 28, /*!< 28 EFR32 AGC Interrupt */
  PROTIMER_IRQn         = 29, /*!< 29 EFR32 PROTIMER Interrupt */
  RTCC_IRQn             = 30, /*!< 30 EFR32 RTCC Interrupt */
  SYNTH_IRQn            = 31, /*!< 31 EFR32 SYNTH Interrupt */
  CRYOTIMER_IRQn        = 32, /*!< 32 EFR32 CRYOTIMER Interrupt */
  RFSENSE_IRQn          = 33, /*!< 33 EFR32 RFSENSE Interrupt */
...
/**************************************************************************//**
 * @defgroup EFR32MG2P233F1024GL125_Core EFR32MG2P233F1024GL125 Core
 * @{
...
/** @} End of group EFR32MG2P233F1024GL125_Core */

/**************************************************************************//**
* @defgroup EFR32MG2P233F1024GL125_Part EFR32MG2P233F1024GL125 Part
* @{
******************************************************************************/
...
#define _SILICON_LABS_32B_PLATFORM_2_GEN_2       /**< Platform 2, generation 2 */
#define _SILICON_LABS_32B_PLATFORM_2_GEN       2 /**< Platform 2, generation 2 */

/* If part number is not defined as compiler option, define it */
#if !defined(EFR32MG2P233F1024GL125)
#define EFR32MG2P233F1024GL125    1 /**< MIGHTY Gecko Part */
#endif

/** Configure part number */
#define PART_NUMBER                "EFR32MG2P233F1024GL125" /**< Part Number */
...
#define RAM0_CODE_MEM_BITS         ((uint32_t) 0x17UL)       /**< RAM0_CODE used bits  */
#define SEQRAM_MEM_BASE            ((uint32_t) 0x21000000UL) /**< SEQRAM base address  */
#define SEQRAM_MEM_SIZE            ((uint32_t) 0x2000UL)     /**< SEQRAM available address space  */
#define SEQRAM_MEM_END             ((uint32_t) 0x21001FFFUL) /**< SEQRAM end address  */
#define SEQRAM_MEM_BITS            ((uint32_t) 0x13UL)       /**< SEQRAM used bits  */
...
#define RAM2_MEM_BITS              ((uint32_t) 0x11UL)       /**< RAM2 used bits  */
...
#define RAM1_MEM_BITS              ((uint32_t) 0x17UL)       /**< RAM1 used bits  */
...
#define CRYPTO1_BITCLR_MEM_BITS    ((uint32_t) 0x10UL)       /**< CRYPTO1_BITCLR used bits  */
...
#define RAM1_CODE_MEM_BITS         ((uint32_t) 0x17UL)       /**< RAM1_CODE used bits  */
...
#define CRYPTO1_MEM_BITS           ((uint32_t) 0x10UL)       /**< CRYPTO1 used bits  */
...
#define CRYPTO0_MEM_BITS           ((uint32_t) 0x10UL)       /**< CRYPTO0 used bits  */
...
#define CRYPTO0_BITSET_MEM_BITS    ((uint32_t) 0x10UL)       /**< CRYPTO0_BITSET used bits  */
...
#define CRYPTO0_BITCLR_MEM_BITS    ((uint32_t) 0x10UL)       /**< CRYPTO0_BITCLR used bits  */
...
#define CRYPTO1_BITSET_MEM_BITS    ((uint32_t) 0x10UL)       /**< CRYPTO1_BITSET used bits  */
...
#define RAM2_CODE_MEM_BITS         ((uint32_t) 0x11UL)       /**< RAM2_CODE used bits  */
...
#define RAM_MEM_BITS               ((uint32_t) 0x17UL)       /**< RAM used bits  */

/** Bit banding area */
#define BITBAND_PER_BASE           ((uint32_t) 0x42000000UL) /**< Peripheral Address Space bit-band area */
#define BITBAND_RAM_BASE           ((uint32_t) 0x22000000UL) /**< SRAM Address Space bit-band area */

/** Flash and SRAM limits for EFR32MG2P233F1024GL125 */
...
#include "system_efr32mg2p.h" /* System Header File */

/** @} End of group EFR32MG2P233F1024GL125_Part */

/**************************************************************************//**
 * @defgroup EFR32MG2P233F1024GL125_Peripheral_TypeDefs EFR32MG2P233F1024GL125 Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/

#include "efr32mg2p_msc.h"
#include "efr32mg2p_emu.h"
#include "efr32mg2p_rmu.h"
#include "efr32mg2p_cmu.h"
#include "efr32mg2p_crypto.h"
#include "efr32mg2p_gpio_p.h"
#include "efr32mg2p_gpio.h"
#include "efr32mg2p_prs_ch.h"
#include "efr32mg2p_prs.h"
#include "efr32mg2p_ldma_ch.h"
#include "efr32mg2p_ldma.h"
#include "efr32mg2p_fpueh.h"
#include "efr32mg2p_gpcrc.h"
#include "efr32mg2p_timer_cc.h"
#include "efr32mg2p_timer.h"
#include "efr32mg2p_usart.h"
#include "efr32mg2p_leuart.h"
#include "efr32mg2p_letimer.h"
#include "efr32mg2p_cryotimer.h"
#include "efr32mg2p_pcnt.h"
#include "efr32mg2p_i2c.h"
#include "efr32mg2p_adc.h"
#include "efr32mg2p_acmp.h"
#include "efr32mg2p_idac.h"
#include "efr32mg2p_vdac_opa.h"
#include "efr32mg2p_vdac.h"
#include "efr32mg2p_csen.h"
#include "efr32mg2p_lesense_st.h"
#include "efr32mg2p_lesense_buf.h"
#include "efr32mg2p_lesense_ch.h"
#include "efr32mg2p_lesense.h"
#include "efr32mg2p_rtcc_cc.h"
#include "efr32mg2p_rtcc_ret.h"
#include "efr32mg2p_rtcc.h"
#include "efr32mg2p_wdog_pch.h"
#include "efr32mg2p_wdog.h"
#include "efr32mg2p_etm.h"
#include "efr32mg2p_smu.h"
#include "efr32mg2p_trng.h"
#include "efr32mg2p_dma_descriptor.h"
#include "efr32mg2p_devinfo.h"
#include "efr32mg2p_romtable.h"

/** @} End of group EFR32MG2P233F1024GL125_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup EFR32MG2P233F1024GL125_Peripheral_Base EFR32MG2P233F1024GL125 Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32MG2P233F1024GL125_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EFR32MG2P233F1024GL125_Peripheral_Declaration  EFR32MG2P233F1024GL125 Peripheral Declarations
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32MG2P233F1024GL125_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup EFR32MG2P233F1024GL125_Peripheral_Offsets  EFR32MG2P233F1024GL125 Peripheral Offsets
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32MG2P233F1024GL125_Peripheral_Offsets */


/**************************************************************************//**
 * @defgroup EFR32MG2P233F1024GL125_BitFields EFR32MG2P233F1024GL125 Bit Fields
 * @{
 *****************************************************************************/

#include "efr32mg2p_prs_signals.h"
#include "efr32mg2p_dmareq.h"

/**************************************************************************//**
 * @defgroup EFR32MG2P233F1024GL125_WTIMER_BitFields  EFR32MG2P233F1024GL125_WTIMER Bit Fields
 * @{
 *****************************************************************************/
...
#define WTIMER_CTRL_RSSCOIST                        (0x1UL << 29)                             /**< Reload-Start Sets Compare Ouptut initial State */
...
/** @} End of group EFR32MG2P233F1024GL125_WTIMER */



/**************************************************************************//**
 * @defgroup EFR32MG2P233F1024GL125_SYSTICK_BitFields  EFR32MG2P233F1024GL125_SYSTICK Bit Fields
 * @{
 *****************************************************************************/

/** @} End of group EFR32MG2P233F1024GL125_SYSTICK */



/**************************************************************************//**
 * @defgroup EFR32MG2P233F1024GL125_UNLOCK EFR32MG2P233F1024GL125 Unlock Codes
 * @{
 *****************************************************************************/
...
#define PROTIMER_UNLOCK_CODE    0xCE80 /**< PROTIMER unlock code */
#define RTCC_UNLOCK_CODE        0xAEE8 /**< RTCC unlock code */

/** @} End of group EFR32MG2P233F1024GL125_UNLOCK */

/** @} End of group EFR32MG2P233F1024GL125_BitFields */

/**************************************************************************//**
 * @defgroup EFR32MG2P233F1024GL125_Alternate_Function EFR32MG2P233F1024GL125 Alternate Function
 * @{
 *****************************************************************************/

#include "efr32mg2p_af_ports.h"
#include "efr32mg2p_af_pins.h"

/** @} End of group EFR32MG2P233F1024GL125_Alternate_Function */
...
/** @} End of group EFR32MG2P233F1024GL125 */
...
#endif
#endif /* EFR32MG2P233F1024GL125_H */
