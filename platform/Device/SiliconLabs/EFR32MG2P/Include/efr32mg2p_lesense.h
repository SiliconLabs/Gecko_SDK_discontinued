/**************************************************************************//**
 * @file efr32mg2p_lesense.h
 * @brief EFR32MG2P_LESENSE register and bit field definitions
 * @version 5.0.0
 ******************************************************************************
 * @section License
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32MG2P_LESENSE
 * @{
 * @brief EFR32MG2P_LESENSE Register Declaration
 *****************************************************************************/
typedef struct
{
...
/**************************************************************************//**
 * @defgroup EFR32MG2P_LESENSE_BitFields
 * @{
 *****************************************************************************/
...
#define LESENSE_PERCTRL_DACCH0EN                       (0x1UL << 0)                                        /**< DAC CH0 enable. */
...
#define LESENSE_PERCTRL_DACCH1EN                       (0x1UL << 1)                                        /**< DAC CH1 enable. */
...
#define LESENSE_PERCTRL_DACCH1DATA                     (0x1UL << 3)                                        /**< DAC CH1 data selection. */
...
/** @} End of group EFR32MG2P_LESENSE */
/** @} End of group Parts */
