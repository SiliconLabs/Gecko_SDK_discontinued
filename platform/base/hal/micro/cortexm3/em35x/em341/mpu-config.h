/** @file hal/micro/cortexm3/em35x/em341/mpu-config.h
 *
 * @brief MPU configuration for the em341
 *
...
#ifndef __EM341_MPU_CFG_H__
#define __EM341_MPU_CFG_H__
