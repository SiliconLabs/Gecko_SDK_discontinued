/** @file hal/micro/cortexm3/em35x/em341/memmap.h
 * @brief Definition of em341 chip specific memory map information
 *
...
#ifndef __EM341_MEMMAP_H__
#define __EM341_MEMMAP_H__
