/** @file hal/micro/cortexm3/em35x/em342/mpu-config.h
 *
 * @brief MPU configuration for the em342
 *
...
#ifndef __EM342_MPU_CFG_H__
#define __EM342_MPU_CFG_H__
...
#define PERIPH_REGION_ATTR   MATTR(1, PRW_URO, MEM_DEVICE, 0x00, SIZE_64K,  1)
#else
//]]
