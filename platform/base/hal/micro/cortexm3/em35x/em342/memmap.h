/** @file hal/micro/cortexm3/em35x/em342/memmap.h
 * @brief Definition of em342 chip specific memory map information
 *
...
#ifndef __EM342_MEMMAP_H__
#define __EM342_MEMMAP_H__
