...
//INTENTIONALLY INDENTED AND SPACED APART! Keep it that way!  See comment above!
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(     46, RTCC_IRQHandler,              4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     47, SYNTH_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     48, CRYOTIMER_IRQHandler,         4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     49, RFSENSE_IRQHandler,           4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     50, FPUEH_IRQHandler,             1,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     51, SMU_IRQHandler,               4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     52, WTIMER0_IRQHandler,           4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     53, WTIMER1_IRQHandler,           4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     54, PCNT1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     55, PCNT2_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     56, USART2_RX_IRQHandler,         4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     57, USART2_TX_IRQHandler,         4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     58, I2C1_IRQHandler,              4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     59, USART3_RX_IRQHandler,         4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     60, USART3_TX_IRQHandler,         4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     61, VDAC0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     62, CSEN_IRQHandler,              4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     63, LESENSE_IRQHandler,           4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     64, CRYPTO1_IRQHandler,           4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     65, TRNG0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     66, halReserved66Isr,     NVIC_NONE, NVIC_NONE)
#undef SEGMENT
#undef SEGMENT2
