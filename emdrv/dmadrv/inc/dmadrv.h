...
typedef enum
{
  dmadrvPeripheralSignal_NONE = LDMA_CH_MUXSEL_SOURCESEL_NONE,                                                              ///< No peripheral selected for DMA triggering.
  #if defined( LDMA_CH_MUXSEL_SIGSEL_ADC0SCAN )
  dmadrvPeripheralSignal_ADC0_SCAN = LDMA_CH_MUXSEL_SIGSEL_ADC0SCAN | LDMA_CH_MUXSEL_SOURCESEL_ADC0,                        ///< Trig on ADC0_SCAN.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_ADC0SINGLE )
  dmadrvPeripheralSignal_ADC0_SINGLE = LDMA_CH_MUXSEL_SIGSEL_ADC0SINGLE | LDMA_CH_MUXSEL_SOURCESEL_ADC0,                    ///< Trig on ADC0_SINGLE.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_AGCRSSI )
  dmadrvPeripheralSignal_AGC_RSSI = LDMA_CH_MUXSEL_SIGSEL_AGCRSSI | LDMA_CH_MUXSEL_SOURCESEL_AGC,                           ///< Trig on AGC_RSSI.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_CRYPTODATA0RD )
  dmadrvPeripheralSignal_CRYPTO_DATA0RD = LDMA_CH_MUXSEL_SIGSEL_CRYPTODATA0RD | LDMA_CH_MUXSEL_SOURCESEL_CRYPTO,            ///< Trig on CRYPTO_DATA0RD.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_CRYPTODATA0WR )
  dmadrvPeripheralSignal_CRYPTO_DATA0WR = LDMA_CH_MUXSEL_SIGSEL_CRYPTODATA0WR | LDMA_CH_MUXSEL_SOURCESEL_CRYPTO,            ///< Trig on CRYPTO_DATA0WR.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_CRYPTODATA0XWR )
  dmadrvPeripheralSignal_CRYPTO_DATA0XWR = LDMA_CH_MUXSEL_SIGSEL_CRYPTODATA0XWR | LDMA_CH_MUXSEL_SOURCESEL_CRYPTO,          ///< Trig on CRYPTO_DATA0XWR.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_CRYPTODATA1RD )
  dmadrvPeripheralSignal_CRYPTO_DATA1RD = LDMA_CH_MUXSEL_SIGSEL_CRYPTODATA1RD | LDMA_CH_MUXSEL_SOURCESEL_CRYPTO,            ///< Trig on CRYPTO_DATA1RD.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_CRYPTODATA1WR )
  dmadrvPeripheralSignal_CRYPTO_DATA1WR = LDMA_CH_MUXSEL_SIGSEL_CRYPTODATA1WR | LDMA_CH_MUXSEL_SOURCESEL_CRYPTO,            ///< Trig on CRYPTO_DATA1WR.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_I2C0RXDATAV )
  dmadrvPeripheralSignal_I2C0_RXDATAV = LDMA_CH_MUXSEL_SIGSEL_I2C0RXDATAV | LDMA_CH_MUXSEL_SOURCESEL_I2C0,                  ///< Trig on I2C0_RXDATAV.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_I2C0TXBL )
  dmadrvPeripheralSignal_I2C0_TXBL = LDMA_CH_MUXSEL_SIGSEL_I2C0TXBL | LDMA_CH_MUXSEL_SOURCESEL_I2C0,                        ///< Trig on I2C0_TXBL.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_LEUART0RXDATAV )
  dmadrvPeripheralSignal_LEUART0_RXDATAV = LDMA_CH_MUXSEL_SIGSEL_LEUART0RXDATAV | LDMA_CH_MUXSEL_SOURCESEL_LEUART0,         ///< Trig on LEUART0_RXDATAV.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_LEUART0TXBL )
  dmadrvPeripheralSignal_LEUART0_TXBL = LDMA_CH_MUXSEL_SIGSEL_LEUART0TXBL | LDMA_CH_MUXSEL_SOURCESEL_LEUART0,               ///< Trig on LEUART0_TXBL.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_LEUART0TXEMPTY )
  dmadrvPeripheralSignal_LEUART0_TXEMPTY = LDMA_CH_MUXSEL_SIGSEL_LEUART0TXEMPTY | LDMA_CH_MUXSEL_SOURCESEL_LEUART0,         ///< Trig on LEUART0_TXEMPTY.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_MODEMDEBUG )
  dmadrvPeripheralSignal_MODEM_DEBUG = LDMA_CH_MUXSEL_SIGSEL_MODEMDEBUG | LDMA_CH_MUXSEL_SOURCESEL_MODEM,                   ///< Trig on MODEM_DEBUG.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_MSCWDATA )
  dmadrvPeripheralSignal_MSC_WDATA = LDMA_CH_MUXSEL_SIGSEL_MSCWDATA | LDMA_CH_MUXSEL_SOURCESEL_MSC,                         ///< Trig on MSC_WDATA.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_PROTIMERBOF )
  dmadrvPeripheralSignal_PROTIMER_BOF = LDMA_CH_MUXSEL_SIGSEL_PROTIMERBOF | LDMA_CH_MUXSEL_SOURCESEL_PROTIMER,              ///< Trig on PROTIMER_BOF.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_PROTIMERCC0 )
  dmadrvPeripheralSignal_PROTIMER_CC0 = LDMA_CH_MUXSEL_SIGSEL_PROTIMERCC0 | LDMA_CH_MUXSEL_SOURCESEL_PROTIMER,              ///< Trig on PROTIMER_CC0.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_PROTIMERCC1 )
  dmadrvPeripheralSignal_PROTIMER_CC1 = LDMA_CH_MUXSEL_SIGSEL_PROTIMERCC1 | LDMA_CH_MUXSEL_SOURCESEL_PROTIMER,              ///< Trig on PROTIMER_CC1.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_PROTIMERCC2 )
  dmadrvPeripheralSignal_PROTIMER_CC2 = LDMA_CH_MUXSEL_SIGSEL_PROTIMERCC2 | LDMA_CH_MUXSEL_SOURCESEL_PROTIMER,              ///< Trig on PROTIMER_CC2.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_PROTIMERCC3 )
  dmadrvPeripheralSignal_PROTIMER_CC3 = LDMA_CH_MUXSEL_SIGSEL_PROTIMERCC3 | LDMA_CH_MUXSEL_SOURCESEL_PROTIMER,              ///< Trig on PROTIMER_CC3.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_PROTIMERCC4 )
  dmadrvPeripheralSignal_PROTIMER_CC4 = LDMA_CH_MUXSEL_SIGSEL_PROTIMERCC4 | LDMA_CH_MUXSEL_SOURCESEL_PROTIMER,              ///< Trig on PROTIMER_CC4.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_PROTIMERPOF )
  dmadrvPeripheralSignal_PROTIMER_POF = LDMA_CH_MUXSEL_SIGSEL_PROTIMERPOF | LDMA_CH_MUXSEL_SOURCESEL_PROTIMER,              ///< Trig on PROTIMER_POF.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_PROTIMERWOF )
  dmadrvPeripheralSignal_PROTIMER_WOF = LDMA_CH_MUXSEL_SIGSEL_PROTIMERWOF | LDMA_CH_MUXSEL_SOURCESEL_PROTIMER,              ///< Trig on PROTIMER_WOF.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_PRSREQ0 )
  dmadrvPeripheralSignal_PRS_REQ0 = LDMA_CH_MUXSEL_SIGSEL_PRSREQ0 | LDMA_CH_MUXSEL_SOURCESEL_PRS,                           ///< Trig on PRS_REQ0.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_PRSREQ1 )
  dmadrvPeripheralSignal_PRS_REQ1 = LDMA_CH_MUXSEL_SIGSEL_PRSREQ1 | LDMA_CH_MUXSEL_SOURCESEL_PRS,                           ///< Trig on PRS_REQ1.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_TIMER0CC0 )
  dmadrvPeripheralSignal_TIMER0_CC0 = LDMA_CH_MUXSEL_SIGSEL_TIMER0CC0 | LDMA_CH_MUXSEL_SOURCESEL_TIMER0,                    ///< Trig on TIMER0_CC0.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_TIMER0CC1 )
  dmadrvPeripheralSignal_TIMER0_CC1 = LDMA_CH_MUXSEL_SIGSEL_TIMER0CC1 | LDMA_CH_MUXSEL_SOURCESEL_TIMER0,                    ///< Trig on TIMER0_CC1.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_TIMER0CC2 )
  dmadrvPeripheralSignal_TIMER0_CC2 = LDMA_CH_MUXSEL_SIGSEL_TIMER0CC2 | LDMA_CH_MUXSEL_SOURCESEL_TIMER0,                    ///< Trig on TIMER0_CC2.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_TIMER0UFOF )
  dmadrvPeripheralSignal_TIMER0_UFOF = LDMA_CH_MUXSEL_SIGSEL_TIMER0UFOF | LDMA_CH_MUXSEL_SOURCESEL_TIMER0,                  ///< Trig on TIMER0_UFOF.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_TIMER1CC0 )
  dmadrvPeripheralSignal_TIMER1_CC0 = LDMA_CH_MUXSEL_SIGSEL_TIMER1CC0 | LDMA_CH_MUXSEL_SOURCESEL_TIMER1,                    ///< Trig on TIMER1_CC0.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_TIMER1CC1 )
  dmadrvPeripheralSignal_TIMER1_CC1 = LDMA_CH_MUXSEL_SIGSEL_TIMER1CC1 | LDMA_CH_MUXSEL_SOURCESEL_TIMER1,                    ///< Trig on TIMER1_CC1.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_TIMER1CC2 )
  dmadrvPeripheralSignal_TIMER1_CC2 = LDMA_CH_MUXSEL_SIGSEL_TIMER1CC2 | LDMA_CH_MUXSEL_SOURCESEL_TIMER1,                    ///< Trig on TIMER1_CC2.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_TIMER1CC3 )
  dmadrvPeripheralSignal_TIMER1_CC3 = LDMA_CH_MUXSEL_SIGSEL_TIMER1CC3 | LDMA_CH_MUXSEL_SOURCESEL_TIMER1,                    ///< Trig on TIMER1_CC3.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_TIMER1UFOF )
  dmadrvPeripheralSignal_TIMER1_UFOF = LDMA_CH_MUXSEL_SIGSEL_TIMER1UFOF | LDMA_CH_MUXSEL_SOURCESEL_TIMER1,                  ///< Trig on TIMER1_UFOF.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_USART0RXDATAV )
  dmadrvPeripheralSignal_USART0_RXDATAV = LDMA_CH_MUXSEL_SIGSEL_USART0RXDATAV | LDMA_CH_MUXSEL_SOURCESEL_USART0,            ///< Trig on USART0_RXDATAV.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_USART0TXBL )
  dmadrvPeripheralSignal_USART0_TXBL = LDMA_CH_MUXSEL_SIGSEL_USART0TXBL | LDMA_CH_MUXSEL_SOURCESEL_USART0,                  ///< Trig on USART0_TXBL.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_USART0TXEMPTY )
  dmadrvPeripheralSignal_USART0_TXEMPTY = LDMA_CH_MUXSEL_SIGSEL_USART0TXEMPTY | LDMA_CH_MUXSEL_SOURCESEL_USART0,            ///< Trig on USART0_TXEMPTY.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_USART1RXDATAV )
  dmadrvPeripheralSignal_USART1_RXDATAV = LDMA_CH_MUXSEL_SIGSEL_USART1RXDATAV | LDMA_CH_MUXSEL_SOURCESEL_USART1,            ///< Trig on USART1_RXDATAV.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_USART1RXDATAVRIGHT )
  dmadrvPeripheralSignal_USART1_RXDATAVRIGHT = LDMA_CH_MUXSEL_SIGSEL_USART1RXDATAVRIGHT | LDMA_CH_MUXSEL_SOURCESEL_USART1,  ///< Trig on USART1_RXDATAVRIGHT.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_USART1TXBL )
  dmadrvPeripheralSignal_USART1_TXBL = LDMA_CH_MUXSEL_SIGSEL_USART1TXBL | LDMA_CH_MUXSEL_SOURCESEL_USART1,                  ///< Trig on USART1_TXBL.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_USART1TXBLRIGHT )
  dmadrvPeripheralSignal_USART1_TXBLRIGHT = LDMA_CH_MUXSEL_SIGSEL_USART1TXBLRIGHT | LDMA_CH_MUXSEL_SOURCESEL_USART1,        ///< Trig on USART1_TXBLRIGHT.
  #endif
  #if defined( LDMA_CH_MUXSEL_SIGSEL_USART1TXEMPTY )
  dmadrvPeripheralSignal_USART1_TXEMPTY = LDMA_CH_MUXSEL_SIGSEL_USART1TXEMPTY | LDMA_CH_MUXSEL_SOURCESEL_USART1             ///< Trig on USART1_TXEMPTY.
  #endif
} DMADRV_PeripheralSignal_t;
