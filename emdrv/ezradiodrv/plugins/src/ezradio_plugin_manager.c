  ...
  @n @subsection ezradiodrv_plugin Plugin System Layer
    ...
    @subsubsection ezradiodrv_plugin_api Plugin System API 
      ...
      @paragraph ezradiodrv_plugin_transmit Transmit Plugin
        ...
        ezradioStartTransmitBasic(), ezradioStartTransmitConfigured() @n
        ezradioStartTransmitCustom(), ezradioStartTransmitDefault() @n
        ezradioStartTransmitSmart() @n
          Start transmission functions. Each provides different level of
          configuration for the transmission. Each starts an asynchronous
          transmission. The registered callback function is called at the
